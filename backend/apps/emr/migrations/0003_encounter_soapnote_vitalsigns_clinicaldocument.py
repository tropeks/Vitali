...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="encounter",
            index=models.Index(
                fields=["professional", "encounter_date"], name="emr_enc_pro_date_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="encounter",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subjective",
                    models.TextField(blank=True, help_text="Queixa do paciente, história atual"),
                ),
                (
                    "objective",
                    models.TextField(blank=True, help_text="Exame físico, sinais vitais, achados"),
                ),
                (
                    "assessment",
                    models.TextField(
                ...
                (
                    "cid10_codes",
                    models.JSONField(default=list, help_text="Lista de códigos CID-10"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
