...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="outro",
                        max_length=32,
                        verbose_name="Origem da internação",
                    ),
                ),
                (
                    "admission_datetime",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="Data/hora da internação"
                    ),
                ),
                (
                    "expected_discharge_datetime",
                    models.DateTimeField(blank=True, null=True, verbose_name="Alta prevista"),
                ),
                (
                    "actual_discharge_datetime",
                    models.DateTimeField(blank=True, null=True, verbose_name="Alta efetiva"),
                ),
                (
                    "disposition",
                    models.CharField(
        ...
        migrations.AddIndex(
            model_name="admission",
            index=models.Index(
                fields=["status", "admission_datetime"], name="emr_adm_status_dt_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="admission",
            constraint=models.UniqueConstraint(
                condition=models.Q(("current_bed__isnull", False), ("status", "admitted")),
                fields=("current_bed",),
