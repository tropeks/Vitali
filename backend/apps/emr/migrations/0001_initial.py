    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M','Masculino'),('F','Feminino'),('O','Outro'),('N','Não informado')], max_length=20)),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patients_created', to='core.user')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.CharField(choices=[('mild','Leve'),('moderate','Moderada'),('severe','Grave'),('life_threatening','Risco de vida')], max_length=20)),
                ('status', models.CharField(choices=[('active','Ativa'),('inactive','Inativa'),('resolved','Resolvida')], default='active', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allergies', to='emr.patient')),
                ('confirmed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.user')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('chronic','Crônica'),('acute','Aguda'),('surgical','Cirúrgica'),('family','Familiar')], max_length=20)),
                ('status', models.CharField(choices=[('active','Ativa'),('controlled','Controlada'),('resolved','Resolvida')], default='active', max_length=20)),
                ('onset_date', models.DateField(blank=True, null=True)),
                ('notes', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_history', to='emr.patient')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True)),
                ('council_type', models.CharField(choices=[('CRM','CRM'),('COREN','COREN'),('CRF','CRF'),('CRO','CRO'),('CREFITO','CREFITO'),('CRP','CRP')], max_length=10)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='professional', to='core.user')),
            ],
        ...
        migrations.AddIndex(
            model_name='patient',
            index=models.Index(fields=['is_active', 'full_name'], name='emr_patient_active_name_idx'),
        ),
    ]
