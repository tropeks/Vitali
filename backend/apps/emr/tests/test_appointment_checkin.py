...
class TestWaitTimeAvgAnalytics(TenantTestCase):
    ...
    def test_wait_time_avg_min_computed_correctly(self):
        ...
        self._create_appt_with_timestamps(
            arrived_offset_min=0, started_offset_min=10, hours_offset=2
        )
        self._create_appt_with_timestamps(
            arrived_offset_min=0, started_offset_min=20, hours_offset=3
        )
    ...
    def test_wait_time_avg_min_rounded_to_one_decimal(self):
        ...
        self._create_appt_with_timestamps(
            arrived_offset_min=0, started_offset_min=7, hours_offset=4
        )
