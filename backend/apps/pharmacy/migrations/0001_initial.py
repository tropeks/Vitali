...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="drug",
            index=models.Index(
                fields=["controlled_class", "is_active"], name="pharmacy_drug_controlled"
            ),
        ),
        migrations.CreateModel(
            name="Material",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.DecimalField(
                        decimal_places=3, default=decimal.Decimal("0"), max_digits=12
                    ),
                ),
                (
                    "min_stock",
        ...
        migrations.AddIndex(
            model_name="stockitem",
            index=models.Index(
                fields=["drug", "expiry_date"], name="pharmacy_stockitem_drug_expiry"
            ),
        ),
        migrations.AddIndex(
            model_name="stockitem",
            index=models.Index(
                fields=["material", "expiry_date"], name="pharmacy_stockitem_mat_expiry"
            ),
        ),
        migrations.AddIndex(
            model_name="stockitem",
