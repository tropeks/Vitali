    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "accepted",
                    models.BooleanField(blank=True, help_text="None = no feedback yet", null=True),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["event_type", "created_at"], name="ai_aiusagel_event_t_c3212f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="aiusagelog",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tuss_code", "created_at"], name="ai_tussaisu_tuss_co_10429b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tussaisuggestion",
            index=models.Index(
                fields=["accepted", "created_at"], name="ai_tussaisu_accepte_855568_idx"
            ),
        ),
    ]
