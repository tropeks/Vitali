...
urlpatterns = [
    ...
    path(
        ...
        AppointmentsByStatusView.as_view(),
        name="analytics-appts-by-status",
    ),
    ...
    path(
        "billing/operational/",
        BillingOperationalView.as_view(),
        name="analytics-billing-operational",
    ),
    path(
        "billing/monthly-revenue/",
        MonthlyRevenueView.as_view(),
        name="analytics-billing-monthly-revenue",
    ),
    path(
        "billing/denial-by-insurer/",
        DenialByInsurerView.as_view(),
        name="analytics-billing-denial-by-insurer",
    ),
    path(
        "billing/batch-throughput/",
        BatchThroughputView.as_view(),
        name="analytics-billing-batch-throughput",
    ),
    path(
        "billing/glosa-accuracy/",
        GlosaAccuracyView.as_view(),
        name="analytics-billing-glosa-accuracy",
    ),
]
