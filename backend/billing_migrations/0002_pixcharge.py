    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "asaas_charge_id",
                    models.CharField(max_length=100, unique=True, verbose_name="Asaas Charge ID"),
                ),
                (
                    "asaas_customer_id",
                    models.CharField(blank=True, max_length=100, verbose_name="Asaas Customer ID"),
                ),
                (
                    "amount",
                    models.DecimalField(decimal_places=2, max_digits=10, verbose_name="Valor (R$)"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["status", "expires_at"], name="billing_pix_status_expires_idx"
            ),
        ),
    ]
