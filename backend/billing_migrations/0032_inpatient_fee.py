    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service_date",
                    models.DateField(db_index=True, verbose_name="Data do lançamento"),
                ),
                (
                    "description",
                    models.CharField(
                        ...
                        max_length=500,
                        verbose_name="Descrição (snapshot)",
                    ),
                ),
                (
                    "quantity",
                ...
                (
                    "notes",
                    models.CharField(
                        blank=True, default="", max_length=500, verbose_name="Observação"
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["admission", "service_date"], name="bill_inpfee_adm_date_idx"
                    )
                ],
                "constraints": [
