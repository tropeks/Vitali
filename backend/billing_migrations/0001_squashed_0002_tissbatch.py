"""
Squash of billing 0001_initial + 0002_tissbatch_retorno_xml_file.

This migration replaces the two original migrations in apps/billing/migrations/
so Django treats them as already applied when migrating from the old location
(MIGRATION_MODULES now points here).
"""
