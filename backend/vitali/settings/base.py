...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "vitali.pagination.StandardResultsSetPagination",
    "PAGE_SIZE": 50,
...
LIS_INBOUND_SECRET = env("LIS_INBOUND_SECRET", default="")
...
# is_staff/is_superuser) must enrol a TOTP device within the enrollment grace window
