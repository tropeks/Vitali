    ...
    <div className="flex min-h-screen items-center justify-center bg-neu-panel px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-4 text-2xl font-semibold text-neu-ink">
            Portal do Paciente
          </h1>
          <p className="mt-1 text-sm text-neu-inkSoft">Acesse seu acompanhamento na Vitali.</p>
        </div>
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 flex items-center px-3 text-slate-400 hover:text-neu-inkSoft"
