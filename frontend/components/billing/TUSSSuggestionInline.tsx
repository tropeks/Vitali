    ...
    <div role="status" aria-live="polite" className="mt-1">
      ...
      {state.kind === 'degraded' && (
        <button
          type="button"
          disabled
          className="px-2.5 py-1 text-xs font-medium border border-slate-200 text-slate-400 bg-neu-panel rounded-full cursor-default"
      ...
      {pendingSelect && (
        <div className="mt-1.5 flex items-center gap-2 text-xs text-neu-inkSoft bg-yellow-50 border border-yellow-200 rounded-lg px-2.5 py-1.5">
