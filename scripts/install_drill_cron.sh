...
LINHA="0 ${HORA} * * * cd ${REPO} && bash scripts/run_restore_drill.sh --env-file ${APP_DIR}/.env.staging --volume ${VOLUME} --workdir ${APP_DIR}/drill --metrics-dir ${APP_DIR}/drill/metrics >> ${LOG} 2>&1"
